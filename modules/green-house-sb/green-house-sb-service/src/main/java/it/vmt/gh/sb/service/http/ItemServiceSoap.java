...
import it.vmt.gh.sb.service.ItemServiceUtil;
 ...
 * <code>it.vmt.gh.sb.model.ItemSoap</code>. If the method in the
 * service utility returns a
 * <code>it.vmt.gh.sb.model.Item</code>, that is translated to a
 * <code>it.vmt.gh.sb.model.ItemSoap</code>. Methods that SOAP
...
public class ItemServiceSoap {
	...
	public static it.vmt.gh.sb.model.ItemSoap updateItem(
		...
		try {
			it.vmt.gh.sb.model.Item returnValue = ItemServiceUtil.updateItem(
				groupId, userId, itemId, cartId, environmentId, profileId,
				carpentryId, handleId, colorId, price, qty, width, height,
				color);

			return it.vmt.gh.sb.model.ItemSoap.toSoapModel(returnValue);
		}
	...
	public static String findByCartId(long cartId) throws RemoteException {
		try {
			String returnValue = ItemServiceUtil.findByCartId(cartId);
