...
public class ItemServiceHttp {
	...
	public static it.vmt.gh.sb.model.Item updateItem(
		...
		try {
			...
			return (it.vmt.gh.sb.model.Item)returnObj;
		}
	...
	public static String findByCartId(HttpPrincipal httpPrincipal, long cartId)
		...
		try {
			MethodKey methodKey = new MethodKey(
				ItemServiceUtil.class, "findByCartId",
				_findByCartIdParameterTypes1);
	...
	private static final Class<?>[] _updateItemParameterTypes0 = new Class[] {
		...
		long.class, long.class, long.class, int.class, int.class, double.class,
		double.class, String.class
	};
	private static final Class<?>[] _findByCartIdParameterTypes1 = new Class[] {
		long.class
	};
