...
import it.vmt.gh.sb.service.CarpentryService;
...
/**
 * Provides the base implementation for the carpentry remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.vmt.gh.sb.service.impl.CarpentryServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see it.vmt.gh.sb.service.impl.CarpentryServiceImpl
 * @generated
 */
public abstract class CarpentryServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CarpentryService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CarpentryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.vmt.gh.sb.service.CarpentryServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CarpentryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		carpentryService = (CarpentryService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CarpentryService.class.getName();
	}
	...
	@Reference
	protected it.vmt.gh.sb.service.CarpentryLocalService carpentryLocalService;

	protected CarpentryService carpentryService;
