...
import it.vmt.gh.sb.service.EnvironmentService;
...
/**
 * Provides the base implementation for the environment remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.vmt.gh.sb.service.impl.EnvironmentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see it.vmt.gh.sb.service.impl.EnvironmentServiceImpl
 * @generated
 */
public abstract class EnvironmentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EnvironmentService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EnvironmentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.vmt.gh.sb.service.EnvironmentServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EnvironmentService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		environmentService = (EnvironmentService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return EnvironmentService.class.getName();
	}
	...
	@Reference
	protected it.vmt.gh.sb.service.EnvironmentLocalService
