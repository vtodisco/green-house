...
import it.vmt.gh.sb.model.impl.ItemImpl;
import it.vmt.gh.sb.model.impl.ItemModelImpl;
...
public class ItemPersistenceImpl
	...
	public Item[] findByUuid_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(
				session, item, uuid, orderByComparator, true);

			array[1] = item;

			array[2] = getByUuid_PrevAndNext(
				session, item, uuid, orderByComparator, false);
	...
	protected Item getByUuid_PrevAndNext(
		Session session, Item item, String uuid,
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(item.uuid IS NULL OR item.uuid = '')";
	...
	public Item fetchByUUID_G(
		...
		if (result instanceof Item) {
			...
			if (!Objects.equals(uuid, item.getUuid()) ||
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(item.uuid IS NULL OR item.uuid = '') AND ";
	...
	public Item[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, item, uuid, companyId, orderByComparator, true);

			array[1] = item;

			array[2] = getByUuid_C_PrevAndNext(
				session, item, uuid, companyId, orderByComparator, false);
	...
	protected Item getByUuid_C_PrevAndNext(
		Session session, Item item, String uuid, long companyId,
		OrderByComparator<Item> orderByComparator, boolean previous) {
	...
	private FinderPath _finderPathWithPaginationFindByCart;
	private FinderPath _finderPathWithoutPaginationFindByCart;
	private FinderPath _finderPathCountByCart;
	 ...
	 */
	@Override
	public List<Item> findByCart(long cartId) {
		return findByCart(cartId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Item> findByCart(long cartId, int start, int end) {
		return findByCart(cartId, start, end, null);
	}
	 ...
	 */
	@Override
	public List<Item> findByCart(
		long cartId, int start, int end,
		OrderByComparator<Item> orderByComparator) {

		return findByCart(cartId, start, end, orderByComparator, true);
	}
	...
	public List<Item> findByCart(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByCart;
				finderArgs = new Object[] {cartId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByCart;
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_CART_CARTID_2);
	...
	public Item findByCart_First(
		...
		Item item = fetchByCart_First(cartId, orderByComparator);
	...
	public Item fetchByCart_First(
		...
		List<Item> list = findByCart(cartId, 0, 1, orderByComparator);
	...
	public Item findByCart_Last(
		...
		Item item = fetchByCart_Last(cartId, orderByComparator);
	...
	public Item fetchByCart_Last(
		...
		int count = countByCart(cartId);

		if (count == 0) {
			return null;
		}

		List<Item> list = findByCart(
			cartId, count - 1, count, orderByComparator);
	...
	public Item[] findByCart_PrevAndNext(
		...
		try {
			...
			array[0] = getByCart_PrevAndNext(
				session, item, cartId, orderByComparator, true);

			array[1] = item;

			array[2] = getByCart_PrevAndNext(
				session, item, cartId, orderByComparator, false);
	...
	protected Item getByCart_PrevAndNext(
		Session session, Item item, long cartId,
		OrderByComparator<Item> orderByComparator, boolean previous) {
	...
	public void removeByCart(long cartId) {
		for (Item item :
				findByCart(
					cartId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	...
	public int countByCart(long cartId) {
		FinderPath finderPath = _finderPathCountByCart;
	...
	private static final String _FINDER_COLUMN_CART_CARTID_2 =
		"item.cartId = ?";
	 ...
	 */
	@Override
	public List<Item> findByEnvironment(long environmentId) {
	 ...
	 */
	@Override
	public List<Item> findByEnvironment(
		long environmentId, int start, int end) {

		return findByEnvironment(environmentId, start, end, null);
	}
	...
	public List<Item> findByEnvironment(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Item item : list) {
					if (environmentId != item.getEnvironmentId()) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_ENVIRONMENT_ENVIRONMENTID_2);
	...
	public Item findByEnvironment_First(
		...
		Item item = fetchByEnvironment_First(environmentId, orderByComparator);
	...
	public Item fetchByEnvironment_First(
		...
		List<Item> list = findByEnvironment(
	...
	public Item findByEnvironment_Last(
		...
		Item item = fetchByEnvironment_Last(environmentId, orderByComparator);
	...
	public Item fetchByEnvironment_Last(
		...
		int count = countByEnvironment(environmentId);
	...
	public Item[] findByEnvironment_PrevAndNext(
		...
		try {
			...
			array[0] = getByEnvironment_PrevAndNext(
				session, item, environmentId, orderByComparator, true);

			array[1] = item;

			array[2] = getByEnvironment_PrevAndNext(
				session, item, environmentId, orderByComparator, false);
	...
	protected Item getByEnvironment_PrevAndNext(
		Session session, Item item, long environmentId,
		OrderByComparator<Item> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_ENVIRONMENT_ENVIRONMENTID_2 =
		"item.environmentId = ?";
	 ...
	 */
	@Override
	public List<Item> findByProfile(long profileId) {
	 ...
	 */
	@Override
	public List<Item> findByProfile(long profileId, int start, int end) {
	 ...
	 */
	@Override
	public List<Item> findByProfile(
	...
	public Item findByProfile_First(
		...
		Item item = fetchByProfile_First(profileId, orderByComparator);
	...
	public Item fetchByProfile_First(
		...
		List<Item> list = findByProfile(profileId, 0, 1, orderByComparator);
	...
	public Item findByProfile_Last(
		...
		Item item = fetchByProfile_Last(profileId, orderByComparator);
	...
	public Item[] findByProfile_PrevAndNext(
		...
		try {
			...
			array[0] = getByProfile_PrevAndNext(
				session, item, profileId, orderByComparator, true);

			array[1] = item;

			array[2] = getByProfile_PrevAndNext(
				session, item, profileId, orderByComparator, false);
	...
	protected Item getByProfile_PrevAndNext(
		Session session, Item item, long profileId,
		OrderByComparator<Item> orderByComparator, boolean previous) {
	 ...
	 */
	@Override
	public List<Item> findByCarpentry(long carpentryId) {
	 ...
	 */
	@Override
	public List<Item> findByCarpentry(long carpentryId, int start, int end) {
	 ...
	 */
	@Override
	public List<Item> findByCarpentry(
	...
	public List<Item> findByCarpentry(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Item item : list) {
					if (carpentryId != item.getCarpentryId()) {
						list = null;
	...
	public Item findByCarpentry_First(
		...
		Item item = fetchByCarpentry_First(carpentryId, orderByComparator);
	...
	public Item fetchByCarpentry_First(
		...
		List<Item> list = findByCarpentry(carpentryId, 0, 1, orderByComparator);
	...
	public Item findByCarpentry_Last(
		...
		Item item = fetchByCarpentry_Last(carpentryId, orderByComparator);
	...
	public Item fetchByCarpentry_Last(
		...
		List<Item> list = findByCarpentry(
	...
	public Item[] findByCarpentry_PrevAndNext(
		...
		try {
			...
			array[0] = getByCarpentry_PrevAndNext(
				session, item, carpentryId, orderByComparator, true);

			array[1] = item;

			array[2] = getByCarpentry_PrevAndNext(
				session, item, carpentryId, orderByComparator, false);
	...
	protected Item getByCarpentry_PrevAndNext(
		Session session, Item item, long carpentryId,
		OrderByComparator<Item> orderByComparator, boolean previous) {
	...
	private FinderPath _finderPathWithPaginationFindByHandle;
	private FinderPath _finderPathWithoutPaginationFindByHandle;
	private FinderPath _finderPathCountByHandle;
	 ...
	 */
	@Override
	public List<Item> findByHandle(long handleId) {
		return findByHandle(
			handleId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Item> findByHandle(long handleId, int start, int end) {
		return findByHandle(handleId, start, end, null);
	}
	 ...
	 */
	@Override
	public List<Item> findByHandle(
		long handleId, int start, int end,
		OrderByComparator<Item> orderByComparator) {

		return findByHandle(handleId, start, end, orderByComparator, true);
	}
	...
	public List<Item> findByHandle(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByHandle;
				finderArgs = new Object[] {handleId};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByHandle;
			finderArgs = new Object[] {handleId, start, end, orderByComparator};
		}
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_HANDLE_HANDLEID_2);
	...
	public Item findByHandle_First(
		...
		Item item = fetchByHandle_First(handleId, orderByComparator);
	...
	public Item fetchByHandle_First(
		...
		List<Item> list = findByHandle(handleId, 0, 1, orderByComparator);
	...
	public Item findByHandle_Last(
		...
		Item item = fetchByHandle_Last(handleId, orderByComparator);
	...
	public Item fetchByHandle_Last(
		...
		int count = countByHandle(handleId);

		if (count == 0) {
			return null;
		}

		List<Item> list = findByHandle(
			handleId, count - 1, count, orderByComparator);
	...
	public Item[] findByHandle_PrevAndNext(
		...
		try {
			...
			array[0] = getByHandle_PrevAndNext(
				session, item, handleId, orderByComparator, true);

			array[1] = item;

			array[2] = getByHandle_PrevAndNext(
				session, item, handleId, orderByComparator, false);
	...
	protected Item getByHandle_PrevAndNext(
		Session session, Item item, long handleId,
		OrderByComparator<Item> orderByComparator, boolean previous) {
	...
	public int countByHandle(long handleId) {
		FinderPath finderPath = _finderPathCountByHandle;

		Object[] finderArgs = new Object[] {handleId};
	...
	private static final String _FINDER_COLUMN_HANDLE_HANDLEID_2 =
		"item.handleId = ?";
	...
	protected void cacheUniqueFindersCache(ItemModelImpl itemModelImpl) {
		...
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, itemModelImpl, false);
	}
	...
	public Item create(long itemId) {
		...
		item.setCompanyId(CompanyThreadLocal.getCompanyId());
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new ItemModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", Item.class.getName()));
		...
		_finderPathWithPaginationFindByCart = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByCart",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"cartId"}, true);

		_finderPathWithoutPaginationFindByCart = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByCart",
			new String[] {Long.class.getName()}, new String[] {"cartId"}, true);

		_finderPathCountByCart = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCart",
			new String[] {Long.class.getName()}, new String[] {"cartId"},
			false);

		_finderPathWithPaginationFindByEnvironment = _createFinderPath(
		...
		_finderPathWithPaginationFindByHandle = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByHandle",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"handleId"}, true);

		_finderPathWithoutPaginationFindByHandle = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByHandle",
			new String[] {Long.class.getName()}, new String[] {"handleId"},
			true);

		_finderPathCountByHandle = _createFinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByHandle",
			new String[] {Long.class.getName()}, new String[] {"handleId"},
			false);
	}
	...
	private static class ItemModelArgumentsResolver
		...
		private Object[] _getValue(
			ItemModelImpl itemModelImpl, String[] columnNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] = itemModelImpl.getColumnOriginalValue(
						columnName);
				}
				else {
