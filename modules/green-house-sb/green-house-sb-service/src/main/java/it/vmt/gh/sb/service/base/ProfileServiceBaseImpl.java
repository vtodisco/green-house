...
import it.vmt.gh.sb.service.ProfileService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.vmt.gh.sb.service.impl.ProfileServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see it.vmt.gh.sb.service.impl.ProfileServiceImpl
 * @generated
 */
public abstract class ProfileServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ProfileService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProfileService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>it.vmt.gh.sb.service.ProfileServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProfileService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		profileService = (ProfileService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProfileService.class.getName();
	}
	...
	@Reference
	protected it.vmt.gh.sb.service.ProfileLocalService profileLocalService;
